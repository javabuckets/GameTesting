...
public class SimpleFullScreenGame {
	...
	public static void main( String[] args ) {
		...
		BufferedImage bi = gc.createCompatibleImage( 1920, 1080 );
		...
		while( running ) {
			...
			try {
				...
				for( int i = 0; i < 20; ++i ) {
					...
					int x = rand.nextInt( 1920/2 );

					int y = rand.nextInt( 1080/2 );

					int w = rand.nextInt( 1920/2 );

					int h = rand.nextInt( 1080/2 );
